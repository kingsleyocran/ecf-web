  ...
  return {
    props: {
      ...
      metaDataTag: {
        ...
        keywords: `${articleData.name}, ECF knowledge hub, climate Africa`,
        alternates: { canonical: `https://ecfrontiers.org/resources/hub/${articleData.id}` },
        openGraph: { type: "website", images: [{ url: articleData.imgUrl || "https://ecfrontiers.org/hero-image.png", width: 1200, height: 630, alt: articleData.name, type: "image/png" }] },
        twitter: { images: [{ url: articleData.imgUrl || "https://ecfrontiers.org/hero-image.png" }] },
      },
      jsonLd: [{ "@context": "https://schema.org", "@type": "Article", headline: articleData.name, description: articleData.description, author: { "@type": "Person", name: articleData.author }, publisher: { "@type": "Organization", name: "Emerging Climate Frontiers" }, url: `https://ecfrontiers.org/resources/hub/${articleData.id}` }],
    },
  };
}

const KnowledgeHubDetailRoute: NextPage<Props> = ({ article, metaDataTag, jsonLd }) => {
...
export default KnowledgeHubDetailRoute;
