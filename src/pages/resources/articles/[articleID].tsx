  ...
  return {
    props: {
      ...
      metaDataTag: {
        ...
        alternates: { canonical: `https://ecfrontiers.org/resources/articles/${articleData.id}` },
      ...
      jsonLd: [{ "@context": "https://schema.org", "@type": "Article", headline: articleData.name, description: articleData.description, author: { "@type": "Person", name: articleData.author }, publisher: { "@type": "Organization", name: "Emerging Climate Frontiers" }, url: `https://ecfrontiers.org/resources/articles/${articleData.id}` }],
    },
  };
}
