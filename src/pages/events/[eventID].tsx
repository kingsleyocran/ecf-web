...
export async function getServerSideProps(context: any) {
  ...
  const metaDataTag = {
    ...
    keywords: `${eventData.title}, ECF events, climate event Africa, frontier climate technologies`,
    openGraph: {
      title: `${eventData.title} | ECF Events`,
      description: eventData.description,
      type: "website",
      url: `https://ecfrontiers.org/events/${eventData.id}`,
      publishedTime: "2025-01-23",
      modifiedTime: "2025-01-23",
      authors: ["Emerging Climate Frontiers (ECF)"],
      tags: "ECF Events, Climate Event, Africa, Frontier Climate Technologies",
      images: [
        {
          url: eventData.imgUrl || "https://ecfrontiers.org/hero-image.png",
          width: 1200,
          height: 630,
          alt: eventData.title,
          type: "image/png",
    ...
    alternates: {
      canonical: `https://ecfrontiers.org/events/${eventData.id}`,
    },
  };
  ...
  return {
    props: {
      ...(await serverSideTranslations(locale ?? "en", ["common", "news-events"], nextI18NextConfig)),
      event: eventData,
      metaDataTag,
      jsonLd,
    },
