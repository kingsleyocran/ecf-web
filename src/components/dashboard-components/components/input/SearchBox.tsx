...
function SearchBox({
  ...
  return (
    <div className={`${isWide ? "w-full" : ""} flex flex-col`}>
      <div
        className="relative flex flex-row items-center bg-[#EAEAEA] px-4 py-0.5
          focus:ring-transparent w-full placeholder:text-neutral-400 tracking-[0px] rounded-lg border-[1px] border-transparent focus:border-neutral-300"
      >
        <input
          ref={inputRef}
          name="text"
          type={"text"}
          autoComplete="off"
          className={`ml-5 bg-[#EAEAEA]
          focus:ring-transparent w-full placeholder:text-neutral-400 tracking-[0px] border-transparent focus:border-transparent`}
        ...
        {inputValue && (
          <button
            ...
            type="button"
            className="bg-neutral-600 h-[20px] w-[20px] rounded-full  absolute inset-y-0 right-0 mx-[14px] my-3 flex flex-row items-center justify-center"
          >
            <CloseIcon
              fill="#fff"
              width="8"
