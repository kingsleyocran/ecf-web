...
export default function SingleAddFromSelectDropdown({
  dataList,
  isRequired = true,
  onInputChange,
  value,
  ...
  function inputHandler(val: string | null) {
          ...
          <>
            <PopoverButton
              ...
              className={`
                ...
                font-medium  text-sm
                group flex flex-row gap-2 w-full justify-between items-center rounded-md bg-white px-3 py-2  focus:outline-none `}
            >
              <span>{selectedValue || placeholderText}</span>

              {selectedValue ? (
                <button
                  onClick={() => inputHandler(null)}
                  className=""
                  type="button"
                >
                  <CloseIcon
                    ...
                    <PopoverPanel className={"block"}>
                      {({ close }) => (
                        <div className="flex flex-row justify-start items-center gap-2">
                          <p className="pl-3 pr-1 font-medium text-black text-sm">
                            Other
                          </p>
