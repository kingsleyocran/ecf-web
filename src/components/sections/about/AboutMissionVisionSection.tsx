      ...
      <div className="w-full max-w-[1920px] 2xl:mx-auto px-4 md:px-8 lg:px-16 flex flex-col gap-20 md:gap-32">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
          <div className="flex-1">
            <h2 className="text-bold-2xl text-[#E0C759] mb-6">Our Mission</h2>
            <p className="text-normal-base text-black/80 max-w-[480px]">
          ...
          <div className="flex-1 flex justify-end">
            <div className="relative w-full max-w-[520px] aspect-[4/3] rounded-2xl overflow-hidden">
              <Image
        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="flex-1">
            <h2 className="text-bold-2xl text-[#E0C759] mb-6">
              Our North Star
            </h2>
            <p className="text-normal-base text-black/80 max-w-[480px]">
