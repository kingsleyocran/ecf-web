      ...
      <div className="w-full max-w-[1920px] flex flex-col 2xl:mx-auto px-4 md:px-8 lg:px-16 py-12  items-center gap-36">
        ...
        <div className="relative max-w-[700px] w-full">
          <div className="relative z-10 flex flex-col items-center md:items-stretch md:flex-row gap-10">
            ...
            >
              <div className="shrink-0 w-[120px] h-[120px] md:w-[220px] md:h-[220px] rounded-full flex flex-col items-center justify-center bg-[#0098D4]">
                <span className="text-white text-3xl md:text-5xl font-bold tracking-wide">
                  {t("aiPage.hero.abbreviation")}
                </span>
              </div>
              <div className="-mt-5 w-[25px] flex-1 h-full stem-gradient-blue-ai" />
            </motion.div>

            {/* Heading + objective bubbles */}
            <div className="flex flex-col items-center md:items-start">
              ...
              <div className="max-w-[580px] text-center md:text-left flex flex-col gap-3">
                <MaskText
                  ...
                  triggerOnce={true}
                  animationDelay={0.15}
                  extraClassNames="md:hidden block text-center text-[#E0C759]/70 text-sm md:text-base font-medium tracking-[6px] uppercase"
                >
                  {t("aiPage.hero.fullName")}
                </MaskText>
...
export default AiObjectivesSection;
