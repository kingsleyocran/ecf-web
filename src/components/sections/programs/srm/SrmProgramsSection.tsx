...
function ProgramCard({
  ...
  const prefix = `srmPage.programs.items.${program.key}`;
    ...
    <div id={program.key} className="rounded-3xl overflow-hidden bg-white/5 border border-white/10 mb-10 last:mb-0">
      ...
      <div className="p-8 md:p-12 flex flex-col gap-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div>
            <ColumnHeader
              label={t("srmPage.programs.objectivesLabel")}
              delay={0.05}
            />
          ...
          <div className="md:border-l md:border-white/10 md:pl-10">
            <ColumnHeader
              label={t("srmPage.programs.impactsLabel")}
              delay={0.05}
            />
        ...
        {program.partners && (
          <div className="pt-6 border-t border-white/10">
            <ColumnHeader
              label={t("srmPage.programs.partnersLabel")}
              delay={0.05}
            />
    ...
    <section className="w-full bg-[#034D6B] py-16 md:py-24">
      <div className="w-full max-w-[1920px] 2xl:mx-auto px-4 md:px-8 lg:px-16">
        ...
        <div className="mb-12">
          ...
          >
            {t("srmPage.programs.sectionTitle")}
          </MaskText>
          <MaskText
            positionFrom={30}
            animationDelay={0.1}
          ...
          >
            {t("srmPage.programs.sectionHeading")}
          </MaskText>
        </div>
